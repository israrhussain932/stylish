...
class TColors{
  ...
  static var darkContainer = Colors.white.withOpacity(0.1);
  // Button Colors

  static const Color buttonPrimary = Color(0xFFF83758);
...
//   on working
  ...
  static const Color info = Color(0xFFF83758);
